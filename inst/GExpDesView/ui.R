...
#  Crysttian Arantes Paixao - <crysttian.arantes.paixao.ufsc.br>    #
                  ...
                  (
                    ...
                    mainPanel(tags$div(align="center", valign="top", img(src='http://rbras.org.br/sites/default/files/pictures/logo3.png', width='560')),
                              tags$div( align="center",
                                             ...
                                             br(),
                                             HTML("- Dr Crysttian Arantes Paixão - crysttian.arantes.paixao.ufsc.br "),
                                             br(),
                                             ...
                                             br(),
                                             br(),
                                             HTML("- Dr.Eric Batista Ferreira-  eric.ferreira@unifal-mg.edu.br"),
                                             br(),
                                             HTML("- Dr.Denismar Alves Nogueira- denismar.nogueira@unifal-mg.edu.br"),
                                             br(),
