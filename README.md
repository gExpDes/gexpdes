...
**Versão atual do pacote é a 1.0.1**
...
A versão do pacote lançada foi a 1.0 durante a 54ª RBRAS e 18º SEAGRO. Atualmente, a versão é a 1.0.1 que inseriu algumas correções sugeridas pelos usuários/colaboradores.
